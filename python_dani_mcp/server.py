...
class DaniMCPServer:
    ...
    def _register_tools(self) -> None:
        ...
        self.mcp.tool(meta={"ui": {"resourceUri": RESOURCE_URIS["about_me"]}})(self.tools.about_me)
        self.mcp.tool(meta={"ui": {"resourceUri": RESOURCE_URIS["technologies"]}})(self.tools.technologies)
        self.mcp.tool(meta={"ui": {"resourceUri": RESOURCE_URIS["projects"]}})(self.tools.projects)
        self.mcp.tool()(self.tools.contact)
        self.mcp.tool()(self.tools.send_contact_message)
        self.mcp.tool()(self.tools.talks)
        self.mcp.tool(meta={"ui": {"resourceUri": RESOURCE_URIS["skills"]}})(self.tools.skills)
